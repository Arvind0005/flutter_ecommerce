  ...
  Widget build(BuildContext context) {
            ...
            children: [
              GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: controlDecoration()
                      .copyWith(color: login ? Colors.red : Colors.white),
                  width: width / 2,
                  height: 70,
                ),
              ),
    ...
    login_con() async {
      if (formkey.currentState.validate()) {
        ...
        dynamic result = await fauth.Loginwithemailandpassword(email, password);
        setState(() {
          loading = false;
        });
    ...
    signup_con() async {
      if (formkey.currentState.validate()) {
        ...
        dynamic result =
            await fauth.Signupwithemailandpassword(email, password);
        setState(() {
          loading = false;
        });
        if (FirebaseAuth.instance.currentUser?.uid != null) {
              ...
              child: Form(
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: login ? () => login_con() : () => signup_con(),
                      child: Container(
                        child: Center(
                            child: Text(
                          login ? "LOGIN" : "Sign In",
